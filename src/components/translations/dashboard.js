export default {
    en: {
        urllist: {
            ...
            scan_type_both: 'Both Website and E-mail (results in two reports)',
    ...
    nl: {
        urllist: {
            ...
            scan_type_both: 'Zowel Website als E-Mail (in afzonderlijke rapporten)',
            ...
            automated_scan_frequency: {
                ...
                every_quarter: 'Herhaal aan het begin van elk kwartaal',
                every_month: 'Herhaal aan het begin van elke maand',
