  ...
  methods: {
    ...
    load_visible_metrics: function () {
      const default_metric_visibility = {
        ...
        internet_nl_web_rpki: {visible: true},
        internet_nl_web_appsecpriv_securitytxt: {visible: true},
        internet_nl_mail_dashboard_rpki: {visible: true},
        internet_nl_web_rpki_exists: {visible: true},
        internet_nl_web_rpki_valid: {visible: true},
        internet_nl_web_ns_rpki_exists: {visible: true},
        internet_nl_web_ns_rpki_valid: {visible: true},
        internet_nl_mail_rpki_exists: {visible: true},
        internet_nl_mail_rpki_valid: {visible: true},
        internet_nl_mail_ns_rpki_exists: {visible: true},
        internet_nl_mail_ns_rpki_valid: {visible: true},
        internet_nl_mail_mx_ns_rpki_exists: {visible: true},
        internet_nl_mail_mx_ns_rpki_valid: {visible: true},
      };

      http.get(`/api/v1/settings/account/report`).then(settings => {
