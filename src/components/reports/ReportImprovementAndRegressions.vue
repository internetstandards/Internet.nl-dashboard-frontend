<template>
  ...
  <div v-else>
    ...
    <ul>
      <li><img src="/static_frontend/images/report_comparison_improved.png"> {{comparison.improvement}} {{ $t('improvement') }}</li>
      <li><img src="/static_frontend/images/report_comparison_regressed.png"> {{comparison.regression}} {{ $t('regression') }}</li>
    ...
    <ReportImprovementAndRegressionsTable :items="comparison.comparison_table_improvement" v-if="comparison.comparison_table_improvement.length > 0"/>
    <ReportImprovementAndRegressionsTable :items="comparison.comparison_table_regression"  v-if="comparison.comparison_table_regression.length > 0"/>
  </div>
