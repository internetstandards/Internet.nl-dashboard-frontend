<template>
  <section>
    ...
    <b-button v-if="totp" size="sm" variant="outline-secondary" to="/account/2fa/totp/deactivate">Deactivate</b-button>
    <b-button v-else size="sm" variant="outline-secondary" to="/account/2fa/totp/activate">Activate</b-button>
    ...
    <b-button v-if="webauthnCount" size="sm" variant="outline-secondary" to="/account/2fa/webauthn">Manage</b-button>
    <b-button v-else size="sm" variant="outline-secondary" to="/account/2fa/webauthn/add">Add</b-button>
    ...
    <div class="d-flex gap-2">
      <b-button size="sm" variant="outline-secondary" to="/account/2fa/recovery-codes">View</b-button>
      <b-button size="sm" variant="outline-secondary" to="/account/2fa/recovery-codes/generate">Generate</b-button>
    </div>
  </section>
</template>
